...
const resetTargets = Object.freeze([
    ...
    { group: 'Runtime customer case', model: CustomerCaseEvent, seed: '-', note: 'Immutable customer case timeline' },
    { group: 'Runtime customer case', model: CustomerCaseMessage, seed: '-', note: 'Customer and garage case messages' },
    { group: 'Runtime customer case', model: CustomerCase, seed: '-', note: 'After-service issue cases' },
    { group: 'Runtime customer case', model: BookingHandover, seed: '-', note: 'Vehicle handover state and inspection snapshot' },
    ...
    { group: 'Runtime booking', model: BookingViolationEvent, seed: '-', note: 'Generated from customer booking violation events' },
