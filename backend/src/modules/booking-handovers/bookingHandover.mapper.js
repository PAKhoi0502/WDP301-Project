...
const toBookingHandoverDto = (handover) => {
    ...
    return {
        ...
        customer_response_source: item.customer_response_source,
        customer_response_recorded_by_id: toId(item.customer_response_recorded_by_id),
        customer_response_recorded_by: toUserSummary(item.customer_response_recorded_by_id),
        customer_response_note: item.customer_response_note,
