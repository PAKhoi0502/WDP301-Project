...
const toPromotionDto = (promotion) => {
    ...
    return {
        ...
        audience: plainPromotion.audience,
        phone_required: plainPromotion.phone_required,
        per_phone_limit: plainPromotion.per_phone_limit,
        ...
        reserved_count: plainPromotion.reserved_count,
