...
const bookingSchema = {
    ...
    properties: {
        ...
        payment_waived_at: { type: 'string', format: 'date-time', nullable: true },
        payment_waived_by_id: { type: 'string', nullable: true },
        payment_waiver_case_id: { type: 'string', nullable: true },
        payment_waiver_reason: { type: 'string', nullable: true },
