...
const toCustomerLoyaltyDto = (loyalty) => {
    ...
    return {
        ...
        qualifying_points: plainLoyalty.qualifying_points ?? plainLoyalty.total_points,
        bonus_points: plainLoyalty.bonus_points || 0,
...
const toPointTransactionDto = (transaction) => {
    ...
    return {
        ...
        source_id: toId(plainTransaction.source_id),
        ...
        counts_toward_tier: plainTransaction.counts_toward_tier !== false,
        rule_snapshot: plainTransaction.rule_snapshot || null,
