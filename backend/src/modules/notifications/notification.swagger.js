...
const notificationSchema = {
    ...
    properties: {
        ...
        related_type: { type: 'string', enum: ['AUTH', 'BOOKING', 'WAITLIST', 'LOYALTY', 'PROMOTION', 'SURVEY', 'BOOKING_HANDOVER', 'CUSTOMER_CASE', 'STAFF', 'BOOKING_PLATE_SCAN'] },
    ...
    '/notifications': {
        get: {
            ...
            parameters: [
                ...
                { name: 'related_type', in: 'query', schema: { type: 'string', enum: ['AUTH', 'BOOKING', 'WAITLIST', 'LOYALTY', 'PROMOTION', 'SURVEY', 'BOOKING_HANDOVER', 'CUSTOMER_CASE', 'STAFF'] } },
